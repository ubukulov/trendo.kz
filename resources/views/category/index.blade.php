    ...
    <div id="primary" class="content-area">
        <main id="main" class="site-main">
            ...
            <div class="shop-control-bar">
                ...
                <form class="woocommerce-ordering" method="get">
                    <select name="orderby" class="orderby">
                        <option value="menu_order"  selected='selected'>@lang('messages.Default sorting')</option>
                        <option value="popularity" >@lang('messages.Sort by popularity')</option>
                        <option value="rating" >@lang('messages.Sort by average rating')</option>
                        <option value="date" >@lang('messages.Sort by newness')</option>
                        <option value="price" >@lang('messages.Sort by price: low to high')</option>
                        <option value="price-desc" >@lang('messages.Sort by price: high to low')</option>
                    </select>
                </form>
                <form style="display: none;" class="form-electro-wc-ppp"><select name="ppp" onchange="this.form.submit()" class="electro-wc-wppp-select c-select"><option value="15"  selected='selected'>Show 15</option><option value="-1" >Show All</option></select></form>
                <nav class="electro-advanced-pagination" style="display: none;">
            ...
            <div class="tab-content">
                ...
                @include('pattern.product-grid-extended')

                @include('pattern.product-list-view')

                @include('pattern.product-list-view-small')
            </div>
        ...
        <aside class="widget woocommerce widget_product_categories electro_widget_product_categories">
            <ul class="product-categories category-single">
                <li class="product_cat">
                    <ul style="display: none;" class="show-all-cat">
                    ...
                    <ul>
                        <li class="cat-item current-cat"><a href="product-category.html">{!! $category->parent->title !!}</a> <span class="count">(13)</span>
                            <ul class='children'>
