                            ...
                            <div class="product-images-wrapper">
                                ...
                                <div class="images electro-gallery">
                                    <div class="thumbnails-single owl-carousel">
                                        <a href="/assets/images/single-product/s1-1.jpg" class="zoom" title="" data-rel="prettyPhoto[product-gallery]"><img src="{{ $product->images }}" data-echo="{{ $product->images }}" class="wp-post-image" alt=""></a>
